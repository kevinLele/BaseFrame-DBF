...
import com.hq.dbf.BaseServer.utils.BeanObjectToMap;
import com.hq.dbf.BaseServer.utils.IDGenerator;
import com.hq.dbf.BaseServer.utils.SysReflectionUtils;
...
public abstract class BaseServiceImpl<Entity extends BaseEntity> implements IBaseService<Entity> {
    ...
    @Override
    public Page findByPage(Page<Entity> page) throws ServiceException {
        return findByPage(page, "getCount", "findByPage");
    }
    ...
    public List<Entity> findByMap(Map<String, Object> map) throws ServiceException {
        return findByMap(map, "findByMap");
    }
}
