...
import com.hq.dbf.BaseDomain.entity.BaseEntity;
import com.hq.dbf.BaseDomain.entity.base.Page;
import com.hq.dbf.BaseDomain.provider.base.IBaseProvider;
import com.hq.dbf.BaseWeb.restful.IBaseRestService;
import com.hq.dbf.BaseWeb.restful.view.JsonViewObject;
...
public abstract class BaseRestServiceImpl<Entity extends BaseEntity> implements IBaseRestService {
    ...
    public abstract IBaseProvider<Entity> getProvider();
    ...
    public String isExist(String jsonStr) {
        ...
        try {
            ...
            List<Entity> entityList = this.getProvider().findByMap(mapBean, "findByMap");
    ...
    protected String getPage(String jsonStr, String countFunc, String pageFunc) {
        ...
        try {
            ...
            page = this.getProvider().findByPage(page, countFunc, pageFunc);
    ...
    public String getAll() {
        ...
        try {
            List<Entity> list = this.getProvider().findAll();
    ...
    protected String getByWhere(String jsonStr, String mapperFunc) {
        ...
        try {
            Map<String, Object> mapBean = JSON.parseObject(jsonStr);
            List<Entity> list = this.getProvider().findByMap(mapBean, mapperFunc);
    ...
    public String getById(String id) {
        ...
        try {
            if (StringUtils.isNotBlank(id)) {
                Entity entity = this.getProvider().findById(id);
    ...
    public String getByName(String name) {
        ...
        try {
            if (StringUtils.isNotBlank(name)) {
                Entity entity = this.getProvider().findByName(name);
                jsonView.successPack(entity);
            }
        } catch (UnauthorizedException unauthorizedException) {
            jsonView.unauthorizedPack();
    ...
    public String removeById(String id) {
        ...
        try {
            //逻辑删除
            flag = this.getProvider().logicDeleteById(id);
            jsonView.successPack(JSON.toJSONString(flag));
        } catch (UnauthorizedException unauthorizedException) {
            jsonView.unauthorizedPack();
        } catch (Exception e) {
    ...
    public String batchRemove(String jsonStr) {
        ...
        try {
            ...
            if (idList.size() <= 0) {
                ...
                //逻辑删除
                flag = this.getProvider().logicBatchDelete(idList);
                jsonView.successPack(JSON.toJSONString(flag));
            }
        } catch (UnauthorizedException unauthorizedException) {
            jsonView.unauthorizedPack();
    ...
    public String removeFromDbById(String id) {
        ...
        try {
            //物理删除
            flag = this.getProvider().deleteById(id);
            jsonView.successPack(JSON.toJSONString(flag));
        } catch (UnauthorizedException unauthorizedException) {
            jsonView.unauthorizedPack();
        } catch (Exception e) {
    ...
    public String batchRemoveFromDb(String jsonStr) {
        ...
        try {
            ...
            if (idList.size() <= 0) {
                ...
                //物理删除
                flag = this.getProvider().batchDelete(idList);
                jsonView.successPack(JSON.toJSONString(flag));
            }
        } catch (UnauthorizedException unauthorizedException) {
            jsonView.unauthorizedPack();
    ...
    public String removeByWhere(String jsonStr) {
        ...
        try {
            Map<String, Object> mapBean = JSON.parseObject(jsonStr);
            flag = this.getProvider().deleteByWhere(mapBean);
    ...
    public String save(String jsonStr) {
        ...
        try {
            ...
            if (entity != null) {
                String id = this.getProvider().save(entity);
    ...
    public String modify(String jsonStr) {
        ...
        try {
            ...
            if (entity != null) {
                jsonView.successPack(this.getProvider().update(entity));
            }
        } catch (UnauthorizedException unauthorizedException) {
            jsonView.unauthorizedPack();
        } catch (Exception e) {
    ...
    public String batchModify(String jsonStr) {
        ...
        try {
            ...
            if (entity != null && idList != null) {
                jsonView.successPack(this.getProvider().batchUpdate(entity, idList));
            }
        } catch (UnauthorizedException unauthorizedException) {
            jsonView.unauthorizedPack();
        } catch (Exception e) {
