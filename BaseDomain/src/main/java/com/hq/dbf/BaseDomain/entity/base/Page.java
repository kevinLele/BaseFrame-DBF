package com.hq.dbf.BaseDomain.entity.base;

import java.io.Serializable;
import java.util.List;
import java.util.Map;

public class Page<Entity extends SerializableEntity> implements Serializable {

    private static final long serialVersionUID = 828551366413247764L;
